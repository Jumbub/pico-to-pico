...
void GPU_DrawLine(GPU_Color color, int16_t x0, int16_t y0, int16_t x1,
                  int16_t y1);
void GPU_DrawLetter(GPU_Color color, const FontDescription *fontDescription,
                    int16_t x, int16_t y, char letter);
void GPU_DrawText(GPU_Color color, const FontDescription *fontDescription,
                  int16_t x, int16_t y, const char *text, uint16_t len);
void GPU_DrawEmptySquare(GPU_Color color, int16_t x, int16_t y, int16_t width,
                         int16_t height);
...
void Texture_DrawLine(GPU_Color color, int16_t x0, int16_t y0, int16_t x1,
                      int16_t y1);
void Texture_DrawLetter(GPU_Color color, const FontDescription *fontDescription,
                        int16_t x, int16_t y, char letter);
void Texture_DrawText(GPU_Color color, const FontDescription *fontDescription,
                      int16_t x, int16_t y, const char *text, uint16_t len);
void Texture_DrawEmptySquare(GPU_Color color, int16_t x, int16_t y,
                             int16_t width, int16_t height);
void Texture_DrawFilledSquare(GPU_Color color, int16_t x, int16_t y,
                              int16_t width, int16_t height);
void Texture_DrawEmptyCircle(GPU_Color color, int16_t x, int16_t y,
                             int16_t radius);
void Texture_DrawFilledCircle(GPU_Color color, int16_t x, int16_t y,
                              int16_t radius);
